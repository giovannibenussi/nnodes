...
class AutosControllerTest < ActionController::TestCase
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post :create, auto: { latitud: @auto.latitud, longitud: @auto.longitud, marca: @auto.marca, modelo: @auto.modelo }
    end
  ...
  test "should update auto" do
    patch :update, id: @auto, auto: { latitud: @auto.latitud, longitud: @auto.longitud, marca: @auto.marca, modelo: @auto.modelo }
    assert_redirected_to auto_path(assigns(:auto))
  end
